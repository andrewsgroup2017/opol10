...
const ACCOUNT_TEMPLATES = Object.freeze({
	CONTAINER: Object.freeze({
		...
		hasAuthStep: false,
		serviceTypes: [ SERVICE_TYPES.CONTAINER ],
		defaultServiceTypes: [ SERVICE_TYPES.CONTAINER ]
	}),
	GENERIC: Object.freeze({
		...
		displayName: 'Weblink',
		hasAuthStep: false,
		serviceTypes: [ SERVICE_TYPES.GENERIC ],
		defaultServiceTypes: [ SERVICE_TYPES.GENERIC ]
	}),
	...
	SLACK: Object.freeze({
		...
		displayName: 'Slack',
		hasAuthStep: true,
		serviceTypes: [ SERVICE_TYPES.SLACK ],
		defaultServiceTypes: [ SERVICE_TYPES.SLACK ]
	}),
	TRELLO: Object.freeze({
		...
		displayName: 'Trello',
		hasAuthStep: true,
		serviceTypes: [ SERVICE_TYPES.TRELLO ],
		defaultServiceTypes: [ SERVICE_TYPES.TRELLO ]
	}),
	ANDREWS: Object.freeze({
		type: 'ANDREWS',
		color: 'rgb(33, 108, 167)',
		displayName: 'Andrews',
		hasAuthStep: true,
		serviceTypes: [ SERVICE_TYPES.ANDREWS ],
		defaultServiceTypes: [ SERVICE_TYPES.ANDREWS ]
	})
})
...
export { ACCOUNT_TEMPLATES, ACCOUNT_TEMPLATE_TYPES, ACCOUNT_TEMPLATE_TYPE_LIST }
