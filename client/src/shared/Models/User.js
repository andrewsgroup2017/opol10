...
class User extends Model {
  ...
  */
	...
	get plan() {
		return this._value_('plan', 'unknown')
	}
	get billingUrl() {
		return this._value_('billingUrl', undefined)
	}
	get proUrl() {
		return this._value_('proUrl', undefined)
	}
	get clientSecret() {
		return this._value_('clientSecret', undefined)
	}
	get accountMessageUrl() {
		return this._value_('messageUrl', undefined)
	}
	get showPlansInSidebar() {
		return this._value_('showPlansInSidebar', true)
	}
	get sidebarPlanExpiryMillis() {
		return this._value_('sidebarPlanExpiry', 0)
	}
	get sidebarPlanExpiryDays() {
		return Math.round(this.sidebarPlanExpiryMillis / MS_IN_DAY)
	}
	...
	get hasAccountLimit() {
		return this.accountLimit !== Infinity
	}
	...
	get classicAccountTypes() {
		return this._value_('accountTypes', [ 'GOOGLE' ])
	}
	get hasAccountTypeRestriction() {
		return this.classicAccountTypes !== null
	}
  ...
  */
	...
	get hasSleepable() {
		return this._value_('hasSleepable', false)
	}
	...
	get extensionLevels() {
		return this._value_('extensionLevels', [])
	}
  ...
  */
	...
	get userEmail() {
		return this._value_('userEmail', null)
	}
	get hasUserEmail() {
	...
	get enableProfileSync() {
		return this._value_('enableProfileSync', false)
	}
	get hasProfiles() {
		return this._value_('hasProfiles', false)
	}
}
