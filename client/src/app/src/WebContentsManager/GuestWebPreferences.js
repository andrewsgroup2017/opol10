...
class GuestWebPreferences {
  ...
  */
	static copyForChild(parentWebPrefrences, childWebPreferences) {
		if (parentWebPrefrences.nodeIntegration === true) {
			throw new Error('Invalid parent webPreferences. nodeIntegration==true')
		}
		if (parentWebPrefrences.nodeIntegrationInWorker === true) {
			throw new Error('Invalid parent webPreferences. nodeIntegrationInWorker==true')
		}
		if (parentWebPrefrences.webviewTag === true) {
			throw new Error('Invalid parent webPreferences. webviewTag==true')
		}
		if (parentWebPrefrences.allowRunningInsecureContent === true) {
			throw new Error('Invalid parent webPreferences. allowRunningInsecureContent==true')
		}
		// if (parentWebPrefrences.webSecurity === false) {
		// 	throw new Error('Invalid parent webPreferences. webSecurity==false')
		// }
