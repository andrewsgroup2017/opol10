...
export default class Provider extends React.Component {
	...
	componentDidMount() {
		...
		andrewsActions.startPollingUpdates()
	...
	componentWillUnmount() {
		...
		andrewsActions.stopPollingUpdates()
  ...
  */
	downloadCompleted = (evt, req) => {
		...
		if (!downloadNotificationEnabled) {
			return
		}
  ...
  */
	...
	render() {
		const { traySettings, launchTraySettings, uiSettings, messagesUnreadCount, hasUnreadActivity } = this.state
		...
		return (
			<div>
				...
				{uiSettings.showAppBadge ? (
					<AppBadge unreadCount={messagesUnreadCount} hasUnreadActivity={hasUnreadActivity} />
				) : (
					undefined
				)}
			</div>
